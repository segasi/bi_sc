...
### Generar subconjunto de la base de datos que sólo contenga los datos de carpetas de investigación (CI) de la categoría de Robo a pasajero a bordo de microbus, con y sin violencia ----

# Selección de categoría de delito para hacer informes
datos_delito <- 
  bd_cdmx %>% 
  filter(categoria_de_delito == "Robo a pasajero a bordo de microbus, con y sin violencia")
...
datos_delito %>%
  ...
  ggsave(str_c("03_graficas/03_miercoles/01_frecuencia_dia_semana_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),".png", sep = ""), width = 13, height = 8, dpi = 200)
...
datos_delito %>% 
  ...
  ggsave(str_c("03_graficas/03_miercoles/02_frecuencia_ci_acumulada_diariamente_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),".png", sep = ""), width = 12, height = 8, dpi = 200)
...
datos_delito %>% 
  ...
  tema +
  theme(legend.position = "none") + 
  ggsave(str_c("03_graficas/03_miercoles/03_tasa_mensual_anualizada_de_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),".png", sep = ""), width = 12, height = 8, dpi = 200) 
...
datos_delito %>% 
  ...
  theme(axis.text.y = element_blank(), 
        panel.grid = element_blank()) + 
  ggsave(str_c("03_graficas/03_miercoles/04_tasa_trimestral_anualizada_de_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),".png", sep = ""), width = 12, height = 8, dpi = 200) 
...
cambio_num_acumulado_delitos_alcaldia %>% 
  ...
  ggsave(str_c("03_graficas/03_miercoles/05_cambio_numero_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),"_1T_2018_vs_1T_2019_por_alcaldia.png", sep = ""), width = 12, height = 8, dpi = 200) 
...
cambio_num_acumulado_delitos_alcaldia %>% 
  ...
  ggsave(str_c("03_graficas/03_miercoles/06_cambio_absoluto_numero_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),"_1T_2018_vs_1T_2019_por_alcaldia.png", sep = ""), width = 12, height = 10, dpi = 200) 
...
datos_delito %>% 
  ...
  theme(panel.grid.major.x = element_blank(),
        legend.position = "none") + 
  ggsave(str_c("03_graficas/03_miercoles/07_tasa_trimestral_anualizada_de_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),"_1T_2018_vs_1T_2019_por_alcaldia.png", sep = ""), width = 12, height = 10, dpi = 200) 
...
bd_cdmx %>% 
  ...
  ggsave("03_graficas/03_miercoles/08_concentracion_porcentual_ci_por_alcaldia.png", width = 13.5, height = 15, dpi = 200) 
...
datos_delito %>%
  ...
  theme(axis.text.x = element_blank(),
        panel.grid.major = element_blank()) +
  ggsave(str_c("03_graficas/03_miercoles/09_numero_total_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),"_por_alcaldia.png", sep = ""), width = 12, height = 10, dpi = 200) 
...
datos_delito %>%
  ...
  theme(axis.text.x = element_blank(),
        panel.grid.major = element_blank()) +
  ggsave(str_c("03_graficas/03_miercoles/10_tasa_por_cada_100_mil_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),"_por_alcaldia.png", sep = ""), width = 12, height = 10, dpi = 200) 
...
top_20_colonias_por_delito %>% 
  ...
  ggsave(str_c("03_graficas/03_miercoles/11_numero_acumulado_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),"_por_colonia.png", sep = ""), width = 13, height = 15, dpi = 200) 
...
faa %>% 
  ...
  ggsave(str_c("03_graficas/03_miercoles/12_mapa_numero_acumulado_ci_por_", str_replace_all(str_to_lower(unique(datos_delito$categoria_de_delito)), " ", "_"),"_por_alcaldia.png", sep = ""), width = 13, height = 13, dpi = 200) 
