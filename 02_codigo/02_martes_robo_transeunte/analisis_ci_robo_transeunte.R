...
### Generar subconjunto de la base de datos que sólo contenga los datos de carpetas de investigación (CI) de la categoría de delito de robo a transeunte en vía pública, con y sin violencia ----

# Selección de categoría de delito para hacer informes
datos_delito <- 
  bd_cdmx %>% 
  filter(categoria_de_delito == "Robo a transeunte en vía pública, con y sin violencia")
